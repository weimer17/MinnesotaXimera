...
What is the length of the remaining side? $\answer[tolerance=0.05]{3}$
\end{question}
\end{question}
...
What is the length of the shorter of the two remaining sides? $\answer[tolerance=0.5]{3}$

What is the length of the longer of the two remaining sides? $\answer[tolerance=0.05]{5}$
\end{question}
\end{question}

Exercise 6

Slide points $A$, $B$ and $C$ until two angles of the triangle have measures $42^\circ$ and $77^\circ$, and the side across from the $42^\circ$ angle has length 5.
